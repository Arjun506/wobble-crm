...
import { FiPackage, FiTruck, FiUpload } from 'react-icons/fi';
        ...
        <div>
            ...
            {requests.length === 0 ? (
                <div className="card text-center py-12">
                    ...
                    <p className="text-slate-400">No approved part requests waiting for dispatch.</p>
                </div>
            ) : (
                            ...
                            <div className="flex flex-wrap justify-between gap-4">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="font-mono text-sm">{req.jobId}</span>
                                    </div>
                                ...
                                <div className="flex items-center gap-3 flex-wrap">
                                    <div className="w-24">
                                        <input
                                            ...
                                            min="1"
                                            max={req.quantity}
                                            value={dispatchQuantities[req.id] || ''}
                                            onChange={(e) => updateQuantity(req.id, e.target.value)}
                                    ...
                                    <button
                                        onClick={() => handleDispatch(req.id, req.caseId, req.quantity)}
                                        disabled={uploading}
