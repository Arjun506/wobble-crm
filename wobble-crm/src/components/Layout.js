    ...
    const getMenuItems = () => {
        ...
        const roleMap = {
            callcenter: [
                ...
                { name: 'Extended Warranty', path: '/callcenter/warranty', icon: <FiCheckCircle size={20} /> },
            ],
            service: [
                { name: 'Register Case', path: '/cases/register', icon: <FiPlusCircle size={20} /> },
            ...
            sales: [{ name: 'Mobile Activation', path: '/sales/activation', icon: <FiCheckCircle size={20} /> }],
            admin: [
                { name: 'Register Case', path: '/cases/register', icon: <FiPlusCircle size={20} /> },
                ...
                <div className="relative">
                    ...
                    {showUserMenu && (
                        <div className="absolute right-0 mt-2 w-48 bg-slate-800 rounded-xl shadow-xl border border-white/10 py-2">
                            ...
                            <button onClick={logout} className="w-full text-left px-4 py-2 text-red-400 hover:bg-red-500/10 flex items-center gap-2"><FiUser size={16} /> Logout</button>
                        </div>
                    )}
                </div>
            </div>
                            ...
                            <div className="relative">
                                ...
                                {showUserMenu && sidebarOpen && (
                                    <div className="absolute bottom-full left-0 right-0 mb-2 bg-slate-800 rounded-xl shadow-xl border border-white/10 p-2">
                                        <button onClick={logout} className="flex items-center gap-2 w-full p-2 text-red-400 hover:bg-red-500/10 rounded-lg"><FiUser size={16} /> Logout</button>
                                    </div>
                                )}
                            </div>
                        </div>
